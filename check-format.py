...
def _check_writeup(writeup_file):
    ...
    try:
        ...
        counted_error('The challenge name in writeup.md (%s) and config.yml (%s) have to be the same.' %
                      (writeup_challenge_name, config_challenge_name))
    except Exception:
        counted_error('The challenge names in writeup.md have to be in H1 style. For example:\n\n'
                      'Challenge name\n==============\n')
